		...
		<>
			...
			<section className="mb-16">
				...
				<h2 className="text-lg bg-gradient-to-r from-orange-100 to-transparent p-4 mb-8 rounded">
					I'm just a guy who loves building stuff and writing things
					on the internet
				</h2>
				...
				<div className="space-y-6 text-lg">
					...
					<div className="space-y-8">
						...
						<div>
							...
							<p>
								Studied hard, got good grades. Did alot of
								public speaking to impress girls. It didn't
								work.
							</p>
						</div>
						...
						<div>
							...
							<p>
								Got into computer science. Learned to code.
								Started building very shitty apps and got
						...
						<div>
							...
							<p>
								...
								/>{' '}
								in africa. Moved to paris to keep buidling and
								learning about startups. Now, I'm working for{' '}
								<OldLink
						...
						<div>
							...
							<p>
								Get the body of christian bale in the dark
								knight. Build one product I'm genuinely proud of
								(and maybe make some money along the way). Get a
								dog and do some{' '}
								<OldLink
									text="side quests"
									href={'/side-quests'}
